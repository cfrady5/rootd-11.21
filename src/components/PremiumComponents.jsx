// DEPRECATED: use components/director/PremiumComponents instead.
export * from './director/PremiumComponents.jsx';

// Legacy copy retained temporarily for reference only.
...
export function SectionCard({ title, description, action, children, minHeight, variant = 'default', tone = 'mint' }) {
  const toneTokens = {
    mint: {
      ...
      heading: '#064e3b',
      body: '#047857',
      shadow: '0 25px 60px rgba(16, 185, 129, 0.18)'
    },
    sky: {
