...
export default function SignUp() {
  ...
  return (
    <div className="auth-card">
      ...
      <div className="oauth-buttons" style={{ marginBottom: '24px' }}>
        <button
          type="button"
      ...
      <form onSubmit={handleSubmit} className="auth-form">
        ...
        <label className="terms-label">
          ...
          />
          <span>I agree to Rootd's <Link to="/terms" className="terms-link">Terms of Service</Link> and <Link to="/privacy" className="terms-link">Privacy Policy</Link></span>
        </label>
